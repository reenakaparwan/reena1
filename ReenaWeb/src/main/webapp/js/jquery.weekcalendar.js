...
(function($) {
  ...
  $.widget('ui.weekCalendar', (function() {
    ...
    return {
      ...
      _renderCalendarHeader: function($calendarContainer) {
        ...
        if (showAsSeparatedUser) {
	      ...
	      console.log("self._getUserName(j)---"+self._getUserName(j));
	...
	console.log("_renderCalendarBody--");
        var self = this, options = this.options,
            showAsSeparatedUser = options.showAsSeparateUsers && options.users && options.users.length,
	...
	//console.log("_setupEventCreationForWeekDay--");
	  ...
	  console.log("--self.element.data--");
	     ...
	     console.log("options.data --"+options.data );
            ...
            if (_currentAjaxCall) {
	      console.log("_currentAjaxCall--"+_currentAjaxCall);
              // first abort current request.
              if (!_jQuery14OrLower) {
                _currentAjaxCall.abort();
		console.log("!_jQuery14OrLower--"+_jQuery14OrLower);
              } else {
                ...
                if (options.loading) {
		  console.log("options.loading--"+options.loading);
	    ...
	    console.log("jsonOptions--"+jsonOptions.val)
